...
Last run **2026-09-10 02:49 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-09-09, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Thu 10 Sep | d+1 | 57.3 | 41.0 to 80.0 | 65.2 | 152 | Unhealthy | clear, 25 to 33C |
| Fri 11 Sep | d+2 | 52.4 | 35.4 to 77.6 | 60.4 | 143 | Unhealthy for Sensitive Groups | drizzle, 25 to 33C |
| Sat 12 Sep | d+3 | 49.9 | 33.6 to 74.1 | 58.0 | 136 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 31C, 2mm |
| Sun 13 Sep | d+4 | 48.5 | 32.6 to 72.1 | 56.7 | 133 | Unhealthy for Sensitive Groups | drizzle, 24 to 32C |
| Mon 14 Sep | d+5 | 47.7 | 32.1 to 71.0 | 56.0 | 131 | Unhealthy for Sensitive Groups | drizzle, 25 to 32C |
| Tue 15 Sep | d+6 | 47.3 | 31.9 to 70.1 | 55.6 | 130 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 29C, 2mm |
| Wed 16 Sep | d+7 | 47.0 | 31.6 to 69.9 | 55.4 | 129 | Unhealthy for Sensitive Groups | thunderstorm, 23 to 28C, 2mm |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 17 | 6% | 10% | -8% | 100% | 76% | 100% |
| d+2 | 16 | 7% | 12% | -10% | 94% | 75% | 100% |
| d+3 | 15 | 10% | 12% | -11% | 100% | 80% | 100% |
| d+4 | 14 | 11% | 13% | -9% | 93% | 79% | 100% |
| d+5 | 13 | 9% | 12% | -11% | 92% | 85% | 100% |
| d+6 | 12 | 12% | 15% | -14% | 92% | 83% | 100% |
| d+7 | 11 | 12% | 17% | -16% | 82% | 73% | 100% |

Across all lead times the 80% range contained the truth **94%** of the time on **98** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Thu 10 Sep | d+1 | 57.3 | 41.0 to 80.0 | 152 | pending | pending | n/a | n/a |
| Fri 11 Sep | d+2 | 52.4 | 35.4 to 77.6 | 143 | pending | pending | n/a | n/a |
...
| Thu 03 Sep | d+2 | 41.4 | 27.8 to 61.7 | 116 | 44.1 | 122 | -6% | yes |
| Fri 04 Sep | d+3 | 41.5 | 27.7 to 62.0 | 116 | 49.3 | 135 | -16% | yes |
| Sat 05 Sep | d+4 | 41.5 | 27.8 to 62.1 | 116 | 45.6 | 126 | -9% | yes |
| Sun 06 Sep | d+5 | 41.5 | 27.8 to 62.2 | 116 | 47.5 | 130 | -13% | yes |
| Mon 07 Sep | d+6 | 41.6 | 27.9 to 61.9 | 116 | 44.5 | 123 | -7% | yes |
...
| Thu 03 Sep | d+3 | 41.8 | 27.9 to 62.5 | 117 | 44.1 | 122 | -5% | yes |
| Fri 04 Sep | d+4 | 41.7 | 27.8 to 62.4 | 116 | 49.3 | 135 | -15% | yes |
| Sat 05 Sep | d+5 | 41.6 | 27.8 to 62.3 | 116 | 45.6 | 126 | -9% | yes |
| Sun 06 Sep | d+6 | 41.6 | 27.9 to 62.0 | 116 | 47.5 | 130 | -12% | yes |
| Mon 07 Sep | d+7 | 41.5 | 27.8 to 62.1 | 116 | 44.5 | 123 | -7% | yes |

_8 older forecasts are not shown. The full journal is in `journal/` and nothing is ever removed from it._
