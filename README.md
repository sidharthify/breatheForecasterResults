...
Last run **2026-09-03 02:54 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-09-02, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Thu 03 Sep | d+1 | 39.4 | 28.1 to 55.3 | 46.1 | 110 | Unhealthy for Sensitive Groups | drizzle, 24 to 31C |
| Fri 04 Sep | d+2 | 40.7 | 27.3 to 60.5 | 47.7 | 114 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 31C, 4mm |
| Sat 05 Sep | d+3 | 41.4 | 27.7 to 61.8 | 48.6 | 115 | Unhealthy for Sensitive Groups | thunderstorm, 22 to 30C, 4mm |
| Sun 06 Sep | d+4 | 41.8 | 28.0 to 62.4 | 49.2 | 117 | Unhealthy for Sensitive Groups | thunderstorm, 23 to 30C, 2mm |
| Mon 07 Sep | d+5 | 42.0 | 28.1 to 62.8 | 49.4 | 117 | Unhealthy for Sensitive Groups | cloudy, 23 to 31C |
| Tue 08 Sep | d+6 | 42.2 | 28.3 to 62.8 | 49.6 | 117 | Unhealthy for Sensitive Groups | clear, 23 to 32C |
| Wed 09 Sep | d+7 | 42.2 | 28.3 to 63.0 | 49.7 | 117 | Unhealthy for Sensitive Groups | drizzle, 24 to 32C |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 10 | 5% | 10% | -7% | 100% | 80% | 100% |
| d+2 | 9 | 7% | 11% | -8% | 100% | 78% | 100% |
| d+3 | 8 | 10% | 11% | -8% | 100% | 88% | 100% |
| d+4 | 7 | 9% | 11% | -2% | 100% | 86% | 100% |
| d+5 | 6 | 8% | 8% | -5% | 100% | 100% | 100% |
| d+6 | 5 | 10% | 11% | -9% | 100% | 100% | 100% |
| d+7 | 4 | 9% | 14% | -11% | 75% | 75% | 100% |

Across all lead times the 80% range contained the truth **98%** of the time on **49** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Thu 03 Sep | d+1 | 39.4 | 28.1 to 55.3 | 111 | pending | pending | n/a | n/a |
...
_1 older forecasts are not shown. The full journal is in `journal/` and nothing is ever removed from it._
