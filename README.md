...
Last run **2026-09-20 02:38 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-09-19, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Sun 20 Sep | d+1 | 49.8 | 35.8 to 69.4 | 58.0 | 136 | Unhealthy for Sensitive Groups | clear, 21 to 32C |
| Mon 21 Sep | d+2 | 49.9 | 33.9 to 73.4 | 57.9 | 136 | Unhealthy for Sensitive Groups | clear, 21 to 32C |
| Tue 22 Sep | d+3 | 49.9 | 33.8 to 73.7 | 57.9 | 136 | Unhealthy for Sensitive Groups | clear, 23 to 33C |
| Wed 23 Sep | d+4 | 50.0 | 33.8 to 73.9 | 57.9 | 136 | Unhealthy for Sensitive Groups | cloudy, 24 to 33C |
| Thu 24 Sep | d+5 | 50.0 | 33.8 to 74.0 | 57.9 | 136 | Unhealthy for Sensitive Groups | cloudy, 24 to 33C |
| Fri 25 Sep | d+6 | 50.0 | 33.9 to 73.7 | 57.9 | 136 | Unhealthy for Sensitive Groups | clear, 24 to 33C |
| Sat 26 Sep | d+7 | 50.0 | 33.8 to 73.9 | 57.9 | 136 | Unhealthy for Sensitive Groups | clear, 22 to 33C |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 27 | 10% | 13% | -3% | 96% | 67% | 100% |
| d+2 | 26 | 12% | 14% | -5% | 92% | 69% | 100% |
| d+3 | 25 | 11% | 15% | -5% | 96% | 72% | 100% |
| d+4 | 24 | 12% | 16% | -4% | 92% | 71% | 100% |
| d+5 | 23 | 13% | 15% | -6% | 91% | 74% | 100% |
| d+6 | 22 | 13% | 17% | -8% | 91% | 73% | 100% |
| d+7 | 21 | 15% | 18% | -10% | 86% | 67% | 100% |

Across all lead times the 80% range contained the truth **92%** of the time on **168** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Sun 20 Sep | d+1 | 49.8 | 35.8 to 69.4 | 136 | pending | pending | n/a | n/a |
...
_18 older forecasts are not shown. The full journal is in `journal/` and nothing is ever removed from it._
