...
Last run **2026-09-11 02:45 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-09-10, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Fri 11 Sep | d+1 | 48.5 | 34.7 to 67.7 | 57.7 | 133 | Unhealthy for Sensitive Groups | drizzle, 25 to 33C |
| Sat 12 Sep | d+2 | 47.8 | 32.3 to 70.6 | 56.6 | 131 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 32C, 2mm |
| Sun 13 Sep | d+3 | 47.3 | 31.9 to 70.2 | 56.0 | 130 | Unhealthy for Sensitive Groups | thunderstorm, 23 to 31C, 3mm |
| Mon 14 Sep | d+4 | 47.1 | 31.7 to 70.0 | 55.7 | 130 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 31C, 2mm |
| Tue 15 Sep | d+5 | 47.0 | 31.6 to 69.8 | 55.5 | 129 | Unhealthy for Sensitive Groups | drizzle, 24 to 30C, 2mm |
| Wed 16 Sep | d+6 | 46.9 | 31.7 to 69.5 | 55.4 | 129 | Unhealthy for Sensitive Groups | thunderstorm, 22 to 29C, 8mm |
| Thu 17 Sep | d+7 | 46.9 | 31.5 to 69.6 | 55.4 | 129 | Unhealthy for Sensitive Groups | drizzle, 21 to 28C, 4mm |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 18 | 8% | 11% | -7% | 100% | 72% | 100% |
| d+2 | 17 | 7% | 11% | -10% | 94% | 76% | 100% |
| d+3 | 16 | 10% | 12% | -11% | 100% | 81% | 100% |
| d+4 | 15 | 10% | 13% | -9% | 93% | 80% | 100% |
| d+5 | 14 | 11% | 13% | -11% | 93% | 86% | 100% |
| d+6 | 13 | 12% | 15% | -14% | 92% | 85% | 100% |
| d+7 | 12 | 13% | 17% | -16% | 83% | 75% | 100% |

Across all lead times the 80% range contained the truth **94%** of the time on **105** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Fri 11 Sep | d+1 | 48.5 | 34.7 to 67.7 | 133 | pending | pending | n/a | n/a |
...
_9 older forecasts are not shown. The full journal is in `journal/` and nothing is ever removed from it._
