...
Last run **2026-08-28 07:52 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-08-27, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Fri 28 Aug | d+1 | 44.3 | 31.4 to 62.7 | 51.5 | 123 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 32C, 4mm |
| Sat 29 Aug | d+2 | 42.0 | 28.0 to 63.0 | 48.5 | 117 | Unhealthy for Sensitive Groups | drizzle, 26 to 33C, 1mm |
| Sun 30 Aug | d+3 | 40.8 | 27.1 to 61.3 | 46.9 | 114 | Unhealthy for Sensitive Groups | thunderstorm, 25 to 33C, 6mm |
| Mon 31 Aug | d+4 | 40.1 | 26.7 to 60.3 | 46.1 | 112 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 32C, 10mm |
| Tue 01 Sep | d+5 | 39.7 | 26.4 to 59.8 | 45.7 | 111 | Unhealthy for Sensitive Groups | thunderstorm, 25 to 30C, 8mm |
| Wed 02 Sep | d+6 | 39.5 | 26.4 to 59.2 | 45.4 | 111 | Unhealthy for Sensitive Groups | drizzle, 24 to 31C, 5mm |
| Thu 03 Sep | d+7 | 39.4 | 26.2 to 59.1 | 45.3 | 110 | Unhealthy for Sensitive Groups | drizzle, 24 to 30C, 2mm |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 4 | 22% | 18% | -18% | 100% | 50% | 100% |
| d+2 | 3 | 19% | 23% | -23% | 100% | 33% | 100% |
| d+3 | 2 | 21% | 21% | -21% | 100% | 50% | 100% |
| d+4 | 1 | 23% | 23% | +23% | 100% | 0% | 100% |
| d+5 | 1 | 1% | 1% | +1% | 100% | 100% | 100% |
| d+6 | 1 | 22% | 22% | -22% | 100% | 100% | 100% |
| d+7 | 1 | 34% | 34% | -34% | 0% | 0% | 100% |

Across all lead times the 80% range contained the truth **92%** of the time on **13** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Fri 28 Aug | d+1 | 44.3 | 31.4 to 62.7 | 123 | pending | pending | n/a | n/a |
