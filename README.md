...
Last run **2026-09-01 04:33 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-08-31, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Tue 01 Sep | d+1 | 42.4 | 30.1 to 59.7 | 50.4 | 118 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 31C, 16mm |
| Wed 02 Sep | d+2 | 42.0 | 28.2 to 62.7 | 49.5 | 117 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 31C, 9mm |
| Thu 03 Sep | d+3 | 41.8 | 27.9 to 62.5 | 49.0 | 116 | Unhealthy for Sensitive Groups | drizzle, 24 to 31C |
| Fri 04 Sep | d+4 | 41.7 | 27.8 to 62.4 | 48.7 | 116 | Unhealthy for Sensitive Groups | thunderstorm, 23 to 31C, 5mm |
| Sat 05 Sep | d+5 | 41.6 | 27.8 to 62.3 | 48.5 | 116 | Unhealthy for Sensitive Groups | thunderstorm, 22 to 30C, 7mm |
| Sun 06 Sep | d+6 | 41.6 | 27.9 to 62.0 | 48.5 | 116 | Unhealthy for Sensitive Groups | cloudy, 24 to 31C |
| Mon 07 Sep | d+7 | 41.5 | 27.8 to 62.1 | 48.4 | 116 | Unhealthy for Sensitive Groups | cloudy, 24 to 31C |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 8 | 5% | 10% | -10% | 100% | 75% | 100% |
| d+2 | 7 | 7% | 13% | -13% | 100% | 71% | 100% |
| d+3 | 6 | 10% | 12% | -12% | 100% | 83% | 100% |
| d+4 | 5 | 13% | 14% | -4% | 100% | 80% | 100% |
| d+5 | 4 | 10% | 9% | -9% | 100% | 100% | 100% |
| d+6 | 3 | 15% | 15% | -15% | 100% | 100% | 100% |
| d+7 | 2 | 23% | 23% | -23% | 50% | 50% | 100% |

Across all lead times the 80% range contained the truth **97%** of the time on **35** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Tue 01 Sep | d+1 | 42.4 | 30.1 to 59.7 | 118 | pending | pending | n/a | n/a |
