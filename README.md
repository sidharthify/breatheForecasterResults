...
Last run **2026-09-22 03:51 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-09-21, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Tue 22 Sep | d+1 | 58.3 | 41.9 to 81.1 | 66.4 | 153 | Unhealthy | cloudy, 24 to 33C |
| Wed 23 Sep | d+2 | 55.3 | 37.6 to 81.2 | 63.2 | 150 | Unhealthy for Sensitive Groups | cloudy, 24 to 33C |
| Thu 24 Sep | d+3 | 53.7 | 36.4 to 79.2 | 61.6 | 146 | Unhealthy for Sensitive Groups | cloudy, 23 to 33C |
| Fri 25 Sep | d+4 | 52.8 | 35.7 to 78.0 | 60.7 | 143 | Unhealthy for Sensitive Groups | cloudy, 23 to 32C |
| Sat 26 Sep | d+5 | 52.3 | 35.4 to 77.3 | 60.2 | 142 | Unhealthy for Sensitive Groups | clear, 22 to 32C |
| Sun 27 Sep | d+6 | 52.0 | 35.3 to 76.6 | 60.0 | 142 | Unhealthy for Sensitive Groups | clear, 22 to 33C |
| Mon 28 Sep | d+7 | 51.8 | 35.1 to 76.6 | 59.8 | 141 | Unhealthy for Sensitive Groups | cloudy, 23 to 32C |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 29 | 10% | 13% | -4% | 97% | 66% | 100% |
| d+2 | 28 | 12% | 14% | -5% | 93% | 68% | 100% |
| d+3 | 27 | 11% | 15% | -6% | 96% | 70% | 100% |
| d+4 | 26 | 12% | 16% | -5% | 92% | 69% | 100% |
| d+5 | 25 | 13% | 15% | -7% | 92% | 72% | 100% |
| d+6 | 24 | 13% | 16% | -9% | 92% | 71% | 100% |
| d+7 | 23 | 15% | 18% | -10% | 87% | 65% | 100% |

Across all lead times the 80% range contained the truth **93%** of the time on **182** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Tue 22 Sep | d+1 | 58.3 | 41.9 to 81.1 | 153 | pending | pending | n/a | n/a |
...
_20 older forecasts are not shown. The full journal is in `journal/` and nothing is ever removed from it._
