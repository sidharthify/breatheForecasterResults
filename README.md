...
Last run **2026-09-08 03:19 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-09-07, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Tue 08 Sep | d+1 | 44.9 | 32.1 to 62.8 | 53.6 | 124 | Unhealthy for Sensitive Groups | clear, 24 to 32C |
| Wed 09 Sep | d+2 | 45.1 | 30.5 to 66.8 | 53.8 | 125 | Unhealthy for Sensitive Groups | drizzle, 25 to 32C |
| Thu 10 Sep | d+3 | 45.3 | 30.5 to 67.2 | 53.9 | 125 | Unhealthy for Sensitive Groups | drizzle, 25 to 33C |
| Fri 11 Sep | d+4 | 45.3 | 30.5 to 67.3 | 54.0 | 125 | Unhealthy for Sensitive Groups | drizzle, 25 to 33C, 2mm |
| Sat 12 Sep | d+5 | 45.4 | 30.5 to 67.4 | 54.0 | 125 | Unhealthy for Sensitive Groups | drizzle, 24 to 33C |
| Sun 13 Sep | d+6 | 45.4 | 30.6 to 67.2 | 54.0 | 125 | Unhealthy for Sensitive Groups | drizzle, 25 to 33C, 1mm |
| Mon 14 Sep | d+7 | 45.4 | 30.6 to 67.4 | 54.0 | 125 | Unhealthy for Sensitive Groups | drizzle, 24 to 30C |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 15 | 5% | 9% | -6% | 100% | 87% | 100% |
| d+2 | 14 | 7% | 10% | -8% | 100% | 86% | 100% |
| d+3 | 13 | 9% | 10% | -8% | 100% | 92% | 100% |
| d+4 | 12 | 9% | 11% | -5% | 100% | 92% | 100% |
| d+5 | 11 | 8% | 9% | -7% | 100% | 100% | 100% |
| d+6 | 10 | 10% | 11% | -10% | 100% | 100% | 100% |
| d+7 | 9 | 11% | 13% | -12% | 89% | 89% | 100% |

Across all lead times the 80% range contained the truth **99%** of the time on **84** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Tue 08 Sep | d+1 | 44.9 | 32.1 to 62.8 | 124 | pending | pending | n/a | n/a |
...
_6 older forecasts are not shown. The full journal is in `journal/` and nothing is ever removed from it._
