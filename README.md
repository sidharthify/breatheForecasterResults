...
Last run **2026-09-05 02:36 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-09-04, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Sat 05 Sep | d+1 | 46.5 | 33.1 to 65.2 | 54.4 | 128 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 30C, 2mm |
| Sun 06 Sep | d+2 | 44.9 | 30.2 to 66.8 | 52.7 | 124 | Unhealthy for Sensitive Groups | drizzle, 22 to 30C, 2mm |
| Mon 07 Sep | d+3 | 44.1 | 29.6 to 65.7 | 51.7 | 122 | Unhealthy for Sensitive Groups | clear, 24 to 31C |
| Tue 08 Sep | d+4 | 43.6 | 29.3 to 65.0 | 51.2 | 121 | Unhealthy for Sensitive Groups | cloudy, 23 to 32C |
| Wed 09 Sep | d+5 | 43.4 | 29.1 to 64.7 | 51.0 | 120 | Unhealthy for Sensitive Groups | drizzle, 24 to 32C |
| Thu 10 Sep | d+6 | 43.2 | 29.1 to 64.2 | 50.8 | 120 | Unhealthy for Sensitive Groups | drizzle, 24 to 32C, 2mm |
| Fri 11 Sep | d+7 | 43.1 | 29.0 to 64.2 | 50.8 | 120 | Unhealthy for Sensitive Groups | drizzle, 24 to 31C, 2mm |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 12 | 8% | 10% | -8% | 100% | 83% | 100% |
| d+2 | 11 | 7% | 11% | -9% | 100% | 82% | 100% |
| d+3 | 10 | 10% | 11% | -8% | 100% | 90% | 100% |
| d+4 | 9 | 9% | 11% | -4% | 100% | 89% | 100% |
| d+5 | 8 | 8% | 9% | -7% | 100% | 100% | 100% |
| d+6 | 7 | 10% | 12% | -10% | 100% | 100% | 100% |
| d+7 | 6 | 11% | 14% | -13% | 83% | 83% | 100% |

Across all lead times the 80% range contained the truth **98%** of the time on **63** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Sat 05 Sep | d+1 | 46.5 | 33.1 to 65.2 | 128 | pending | pending | n/a | n/a |
...
_3 older forecasts are not shown. The full journal is in `journal/` and nothing is ever removed from it._
