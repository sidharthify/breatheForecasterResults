...
Last run **2026-09-17 03:17 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-09-16, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Thu 17 Sep | d+1 | 50.0 | 35.9 to 69.6 | 59.5 | 137 | Unhealthy for Sensitive Groups | thunderstorm, 21 to 28C, 3mm |
| Fri 18 Sep | d+2 | 50.6 | 34.4 to 74.6 | 59.9 | 138 | Unhealthy for Sensitive Groups | clear, 21 to 30C |
| Sat 19 Sep | d+3 | 51.0 | 34.5 to 75.3 | 60.1 | 139 | Unhealthy for Sensitive Groups | cloudy, 21 to 31C |
| Sun 20 Sep | d+4 | 51.2 | 34.6 to 75.7 | 60.2 | 139 | Unhealthy for Sensitive Groups | clear, 21 to 32C |
| Mon 21 Sep | d+5 | 51.3 | 34.6 to 76.0 | 60.3 | 140 | Unhealthy for Sensitive Groups | clear, 22 to 32C |
| Tue 22 Sep | d+6 | 51.4 | 34.8 to 75.8 | 60.3 | 140 | Unhealthy for Sensitive Groups | clear, 23 to 32C |
| Wed 23 Sep | d+7 | 51.4 | 34.7 to 76.1 | 60.3 | 140 | Unhealthy for Sensitive Groups | cloudy, 23 to 32C |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 24 | 10% | 11% | -5% | 100% | 67% | 100% |
| d+2 | 23 | 7% | 12% | -8% | 96% | 70% | 100% |
| d+3 | 22 | 10% | 13% | -9% | 100% | 73% | 100% |
| d+4 | 21 | 12% | 14% | -9% | 95% | 71% | 100% |
| d+5 | 20 | 12% | 14% | -11% | 95% | 75% | 100% |
| d+6 | 19 | 13% | 16% | -13% | 95% | 74% | 100% |
| d+7 | 18 | 15% | 17% | -15% | 89% | 67% | 100% |

Across all lead times the 80% range contained the truth **96%** of the time on **147** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Thu 17 Sep | d+1 | 50.0 | 35.9 to 69.6 | 137 | pending | pending | n/a | n/a |
| Fri 18 Sep | d+2 | 50.6 | 34.4 to 74.6 | 138 | pending | pending | n/a | n/a |
...
| Mon 14 Sep | d+6 | 46.5 | 31.4 to 68.8 | 128 | 53.2 | 145 | -13% | yes |
...
| Mon 14 Sep | d+7 | 45.4 | 30.6 to 67.4 | 125 | 53.2 | 145 | -15% | yes |

_15 older forecasts are not shown. The full journal is in `journal/` and nothing is ever removed from it._
