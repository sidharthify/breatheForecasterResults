...
Last run **2026-09-13 02:34 IST**. Zone `jammu_city`. Index is the **US EPA AQI**. Model and method: [breatheForecaster](https://github.com/sidharthify/breatheForecaster).

## Next seven days

Anchored on 2026-09-12, the last day of sensor data that is actually finished.

| Day | Lead | PM2.5 | 80% range | PM10 | AQI | Category | Weather |
|---|---|---:|---|---:|---:|---|---|
| Sun 13 Sep | d+1 | 55.1 | 39.5 to 76.9 | 64.3 | 149 | Unhealthy for Sensitive Groups | clear, 24 to 33C |
| Mon 14 Sep | d+2 | 52.3 | 35.4 to 77.2 | 61.1 | 142 | Unhealthy for Sensitive Groups | thunderstorm, 23 to 31C, 3mm |
| Tue 15 Sep | d+3 | 50.7 | 34.2 to 75.1 | 59.4 | 138 | Unhealthy for Sensitive Groups | thunderstorm, 24 to 29C, 2mm |
| Wed 16 Sep | d+4 | 49.9 | 33.6 to 74.0 | 58.5 | 136 | Unhealthy for Sensitive Groups | drizzle, 23 to 31C |
| Thu 17 Sep | d+5 | 49.4 | 33.2 to 73.4 | 58.1 | 135 | Unhealthy for Sensitive Groups | thunderstorm, 21 to 30C, 5mm |
| Fri 18 Sep | d+6 | 49.1 | 33.2 to 72.7 | 57.8 | 134 | Unhealthy for Sensitive Groups | cloudy, 22 to 30C |
| Sat 19 Sep | d+7 | 49.0 | 33.0 to 72.7 | 57.7 | 134 | Unhealthy for Sensitive Groups | clear, 21 to 30C |
...
|---|---:|---:|---:|---:|---:|---:|---:|
| d+1 | 20 | 10% | 11% | -7% | 100% | 65% | 100% |
| d+2 | 19 | 7% | 12% | -10% | 95% | 68% | 100% |
| d+3 | 18 | 10% | 13% | -12% | 100% | 72% | 100% |
| d+4 | 17 | 12% | 14% | -10% | 94% | 71% | 100% |
| d+5 | 16 | 12% | 14% | -13% | 94% | 75% | 100% |
| d+6 | 15 | 13% | 16% | -15% | 93% | 73% | 100% |
| d+7 | 14 | 15% | 18% | -17% | 86% | 64% | 100% |

Across all lead times the 80% range contained the truth **95%** of the time on **119** scored days. A range that says 80% should land near 80%: much less and it is overconfident, much more and it is wider than it needs to be. Bias is the direction of the miss, so a positive number means the forecast ran high.
...
|---|---|---:|---|---:|---:|---:|---:|---|
| Sun 13 Sep | d+1 | 55.1 | 39.5 to 76.9 | 149 | pending | pending | n/a | n/a |
...
_11 older forecasts are not shown. The full journal is in `journal/` and nothing is ever removed from it._
